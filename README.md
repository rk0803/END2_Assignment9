...
![formula](https://render.githubusercontent.com/render/math?math=\V \cdot W = \frac{V.W cos(\theta)}{|V|.|W|}) therefore 
![formula](https://render.githubusercontent.com/render/math?math=\cos(\theta)=\frac{V \cdot W}{|V|.|W|}). If the angle between two vectors is very small (i.e. if they are similar), ![formula](https://render.githubusercontent.com/render/math?math=\cos(\theta)) will be close to one. 
